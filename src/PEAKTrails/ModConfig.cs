...
internal class ModConfig
{
    ...
    internal static void Init(ConfigFile config)
    {
        ...
        TogglePressDelay = config.Bind("Controls", "Visibility Press Delay", 0.2f, new ConfigDescription("This sets the amount of time additional key presses will not affect trail visbility after the Visibility Toggle Key has been pressed.", new AcceptableValueRange<float>(0.1f, 3f)));
